...
# This will raise an exception and prevent the app from starting if MongoDB is unavailable
...
try:
    ...
    print("[DATABASE] Application cannot start without MongoDB configuration")
    import sys
    sys.exit(1)
except ConnectionError as e:
    # Connection error (can't reach MongoDB)
    print(f"[DATABASE] Connection error: {e}")
    print("[DATABASE] Application cannot start without MongoDB connection")
    import sys
    sys.exit(1)
except Exception as e:
    # Unexpected error
    print(f"[DATABASE] Unexpected initialization error: {e}")
    import traceback
    traceback.print_exc()
    print("[DATABASE] Application cannot start without MongoDB")
    import sys
    sys.exit(1)
...
# ---------------------------------------------------------------------------
# FL Server import disabled - it should run separately
# The FL server will be started via the /start-fl endpoint when needed
