...
export default function TrialsViewer({ user }) {
  ...
  const handleSelectTrial = (trial) => { setSelectedTrial(trial); setEligData(null); setActiveTab('eligible'); setEligPage(1); setEligScope('global'); setHospitalSearch(''); setDebouncedHospitalSearch(''); setShowBreakdown(null); loadEligibility(trial.drugName, 'eligible', 1, 'global', ''); };
  useEffect(() => {
